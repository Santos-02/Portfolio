...
export const Navigation = () => {
  ...
  return (
    <Navbar
      isBordered
      className="fixed top-0 left-0 w-full z-50 bg-background/70 backdrop-blur-md border-b border-divider"
    ...
    >
      <NavbarContent className="flex justify-between items-center w-full">
        <NavbarBrand>
          ...
          >
            <Link
              className="font-bold text-inherit text-xl bg-gradient-to-r from-primary-500 to-secondary-500 bg-clip-text text-transparent flex items-center gap-2"
              href="/"
